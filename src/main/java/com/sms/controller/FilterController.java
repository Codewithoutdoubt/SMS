...
import com.sms.controller.PlacementController.StudentPlacementDTO;
...
public class FilterController {
    ...
    public String filterStudentsWithFolder(
        ...
        List<com.sms.entity.Placement> placements = placementService.getAllPlacements();
        java.util.Map<Long, com.sms.entity.Placement> placementMap = new java.util.HashMap<>();
        for (com.sms.entity.Placement placement : placements) {
        ...
        for (Student student : filteredStudents) {
            com.sms.entity.Placement placement = placementMap.get(student.getId());
            if (placement != null) {
